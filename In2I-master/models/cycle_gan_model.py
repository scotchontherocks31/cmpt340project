...
class CycleGANModel(BaseModel):
    ...
    def initialize(self, opt):
        ...
        self.netG_A = (networks.define_G(opt.input_nc, opt.output_nc,opt.ngf, 'resnetMM', opt.norm, not opt.no_dropout,opt.init_type, self.gpu_ids))
        self.netG_B=(networks.define_G(opt.input_nc, opt.output_nc, opt.ngf, 'resnetMMReverse', opt.norm, not opt.no_dropout,opt.init_type, self.gpu_ids))
