...
class CycleGANModel(BaseModel):
    ...
    def initialize(self, opt):
        ...
        if self.isTrain:
            ...
            self.netD_B2=networks.define_D(opt.input_nc2, opt.ndf,
                                            opt.which_model_netD,
                                            opt.n_layers_D, opt.norm, use_sigmoid, opt.init_type, self.gpu_ids)
            self.netD_B3=networks.define_D(3, opt.ndf,   #HC
                                            opt.which_model_netD,
                                            opt.n_layers_D, opt.norm, use_sigmoid, opt.init_type, self.gpu_ids)
    ...
    def backward_D_A(self):
        ...
        self.loss_D_A = self.backward_D_conditioned(self.netD_A, self.real_B, fake_B, self.real_Bla, label_fake)
    ...
    def backward_G(self):
        ...
        self.loss_G_B = (self.criterionGAN(pred_fake1, True)+self.criterionGAN(pred_fake2, True)+self.criterionGAN(pred_fake3, True))
        # Forward cycle loss
 ...
 #       D_A = self.loss_D_A.data[0]
    ...
    def get_current_visuals(self):
        ...
        if self.opt.identity > 0.0:
            ...
            return OrderedDict([('real_A1', real_A1), ('real_A2', real_A2),('real_A3', real_A3), ('fake_B', fake_B), ('rec_A1', rec_A1), ('rec_A2', rec_A2),('rec_A3', rec_A3),
                                ('real_B', real_B), ('fake_A1', fake_A1),  ('fake_A2', fake_A2), ('fake_A3', fake_A3), ('rec_B', rec_B)])
