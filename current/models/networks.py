...
def define_D(input_nc, ndf, which_model_netD,
    ...
    elif which_model_netD == 'conditioned':
        netD = NLayerDiscriminatorConditioned(input_nc, ndf, n_layers=3, norm_layer=norm_layer, use_sigmoid=use_sigmoid, gpu_ids=gpu_ids)        
