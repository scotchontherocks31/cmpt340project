...
class BaseOptions():
    ...
    def initialize(self):
        ...
        self.parser.add_argument('--input_nc2', type=int, default=1, help='# of input2 image channels')
        self.parser.add_argument('--input_nc3', type=int, default=1, help='# of input3 image channels')
        ...
        self.parser.add_argument('--no_input', type=int, default=1, help='number of modalities')
